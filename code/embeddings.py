...
def add_mlm_embs(df:pd.DataFrame, hfmodelname:str, layer:int=-1, device:str='cpu'):
    """
    """
...
def add_causal_lm_embs(df, hfmodelname, layer=-1, device='cpu', untrained=False, **kwargs):
    """
    """
    ...
    top_guesses, ranks, true_probs, entropies, embeddings = inference_loop(bsize, layer=layer)
